...
public class PickUpScript : MonoBehaviour
{
    ...
    public float throwForce = 200f; //force at which the object is thrown at
    ...
    {
        PlayerScript.AddToInventory(pickUpObj);
        ...
        if (pickUpObj.GetComponent<Rigidbody>()) //make sure the object has a RigidBody
        {
            ...
            PlayerScript.AddToInventory(pickUpObj);
            WhereInInInventory = PlayerScript.GetNumItemInInventory();
    ...
    void DropObject()
    {
        ...
        //heldObj.layer = 28; //object assigned back to default layer
    ...
    void ThrowObject()
    {
        ...
        heldObjRb = Item.GetComponent<Rigidbody>(); //assign Rigidbody
